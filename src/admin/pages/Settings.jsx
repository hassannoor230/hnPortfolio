...
export default function SettingsAdmin() {
  ...
  return (
    <>
      ...
      >
        <div><label style={{ fontSize: '10px', letterSpacing: '2px', text-transform: 'uppercase', color: 'var(--gold)', marginBottom: '8px', fontFamily: 'var(--font-body)', display: 'block' }}>Site Title *</label>
        ...
        <div><label style={{ fontSize: '10px', letter-spacing: '2px', text-transform: 'uppercase', color: 'var(--gold)', marginBottom: '8px', fontFamily: 'var(--font-body)', display: 'block' }}>Tagline</label>
        ...
        <div><label style={{ fontSize: '10px', letter-spacing: '2px', text-transform: 'uppercase', color: 'var(--gold)', marginBottom: '8px', fontFamily: 'var(--font-body)', display: 'block' }}>Email *</label>
        ...
        <div><label style={{ fontSize: '10px', letter-spacing: '2px', text-transform: 'uppercase', color: 'var(--gold)', marginBottom: '8px', fontFamily: 'var(--font-body)', display: 'block' }}>Phone</label>
        ...
        <div><label style={{ fontSize: '10px', letter-spacing: '2px', text-transform: 'uppercase', color: 'var(--gold)', marginBottom: '8px', fontFamily: 'var(--font-body)', display: 'block' }}>Location</label>
        ...
        <div><label style={{ fontSize: '10px', letter-spacing: '2px', text-transform: 'uppercase', color: 'var(--gold)', marginBottom: '8px', fontFamily: 'var(--font-body)', display: 'block' }}>Avatar URL</label>
        ...
        <div><label style={{ fontSize: '10px', letter-spacing: '2px', text-transform: 'uppercase', color: 'var(--gold)', marginBottom: '8px', fontFamily: 'var(--font-body)', display: 'block' }}>LinkedIn</label>
        ...
        <div><label style={{ fontSize: '10px', letter-spacing: '2px', text-transform: 'uppercase', color: 'var(--gold)', marginBottom: '8px', fontFamily: 'var(--font-body)', display: 'block' }}>GitHub</label>
        ...
        <div><label style={{ fontSize: '10px', letter-spacing: '2px', text-transform: 'uppercase', color: 'var(--gold)', marginBottom: '8px', fontFamily: 'var(--font-body)', display: 'block' }}>Twitter</label>
        ...
        <div><label style={{ fontSize: '10px', letter-spacing: '2px', text-transform: 'uppercase', color: 'var(--gold)', marginBottom: '8px', fontFamily: 'var(--font-body)', display: 'block' }}>Resume URL</label>
        ...
        <div style={{ gridColumn: '1 / -1' }}><label style={{ fontSize: '10px', letter-spacing: '2px', text-transform: 'uppercase', color: 'var(--gold)', marginBottom: '8px', fontFamily: 'var(--font-body)', display: 'block' }}>Bio</label>
        ...
        <div style={{ gridColumn: '1 / -1', display: 'flex', justifyContent: 'flex-end' }}>
          <button type="submit" disabled={submitting} style={{ padding: '12px 24px', background: 'var(--gold)', border: 'none', color: 'var(--bg)', fontFamily: 'var(--font-body)', fontSize: '11px', letterSpacing: '2px', text-transform: 'uppercase', fontWeight: 600, cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: '8px' }} data-cursor="Save"><Save size={14} />{submitting ? 'Saving...' : 'Save Settings'}</button>
        </div>
      </motion.form>
    </>
  )
